...
\author{Kacper Wojtowicz \and Gracjan Adamus \and Dominik Godek}
\date{\today}
...
\begin{table}[H]
    ...
    \input{assets/dataset_shape_table.tex}
\end{table}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{\input{assets/class_distribution_table.tex}}
\end{table}
...
\begin{table}[H]
    ...
    \input{assets/padding_stats_table.tex}
\end{table}
...
\begin{table}[H]
    ...
    \label{tab:training}
    \input{assets/training_table.tex}
\end{table}
...
\begin{table}[H]
    ...
    \label{tab:metrics}
    \resizebox{\textwidth}{!}{\input{assets/metrics_table.tex}}
\end{table}
